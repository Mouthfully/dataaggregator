      ...
      <main id="main">
        ...
        <section className="mx-auto max-w-[1200px] px-8 pt-4 pb-8 md:pt-7 md:pb-12">
          ...
          <div className="mt-8 max-w-[760px]">
            ...
            <h1 className="font-display text-ink mt-2.5 text-[32px] leading-[1.1] font-normal tracking-[-0.03em] md:text-[42px]">
              {HEADING}
            </h1>
        ...
        >
          <h2
            id="roles-heading"
            className="font-display text-ink text-[24px] leading-[1.2] font-normal tracking-[-0.02em] md:text-[28px]"
          >
            {ROLES_HEADING}
          </h2>
          ...
          <ul className="mt-6 grid gap-4 md:grid-cols-2 md:gap-6">
            {ROLES.map((role) => (
              ...
              >
                <h3 className="font-display text-ink text-xl leading-[1.3] font-normal tracking-[-0.01em]">
                  {role.title}
                </h3>
              ...
              {CLAUSES.map((clause, index) => (
                ...
                >
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <h3 className="font-display text-ink text-xl leading-[1.3] font-normal tracking-[-0.01em] md:text-[22px]">
                      {clause.title}
                    </h3>
                    {clause.open === true ? (
