...
export const CLAIMS: readonly Claim[] = [
  ...
  { id: "audit-log", text: "Every query, export and API key is logged.", source: ["15"] },
  ...
  {
    id: "connectors",
    text: "Reads Google Ads, GA4, Search Console, Meta and your affiliate network on your own credentials.",
    source: ["9", "11.9"],
  },
  {
    id: "serp-bought",
 ...
 */
export function allowedClaims(b: Brand = brand): Claim[] {
...
/** Claims currently withheld, with the field that would turn each one on. */
export function withheldClaims(b: Brand = brand): Array<{ claim: Claim; missing: BrandField[] }> {
