      ...
      <main id="main">
        ...
        <section className="mx-auto max-w-[1200px] px-8 pt-4 pb-9 md:pt-7 md:pb-12">
          ...
          <div className="mt-9 max-w-[760px]">
            ...
            <h1 className="font-display text-ink mt-2.5 text-[36px] leading-[1.06] font-normal tracking-[-0.04em] md:text-[42px] lg:text-[48px]">
              {HERO_HEADING_TOP}
              <br />
            ...
            {tiers.map((tier) => (
              ...
              >
                ...
                <p className="my-1 whitespace-nowrap">
                  <strong className="font-display text-ink text-[36px] leading-[1.1] font-normal tracking-[-0.04em]">
                    {tier.monthly}
                  </strong>{" "}
            ...
            <div className="grid gap-8 lg:grid-cols-[minmax(0,320px)_minmax(0,1fr)] lg:gap-12">
              <div className="min-w-0">
                ...
                <h3
                  ...
                  className="font-display text-ink mt-2.5 text-[28px] leading-[1.16] font-normal tracking-[-0.03em] md:text-[32px]"
                >
                  {ENTERPRISE_NAME}
                </h3>
                <p className="font-display text-ink mt-2 text-[28px] leading-[1.1] font-normal tracking-[-0.03em]">
                  {ENTERPRISE_PRICE}
                </p>
        ...
        >
          ...
          <ul className="grid gap-4 md:grid-cols-2 md:gap-6 lg:grid-cols-3">
            {EVERY_PLAN_CARDS.map((card) => (
              ...
              >
                <h3 className="font-display text-ink mb-3 text-lg leading-[1.3] font-normal tracking-[-0.01em]">
                  {card.title}
                </h3>
        ...
        >
          <div className="border-line bg-surface rounded-lg border p-6 md:p-8">
            <h2
              id="imprint-heading"
              className="font-display text-ink text-xl leading-[1.3] font-normal tracking-[-0.01em]"
            >
              {IMPRINT_HEADING}
            </h2>
          ...
          <div className="bg-surface-inverse flex flex-col gap-6 rounded-xl p-8 md:flex-row md:items-center md:justify-between md:p-12">
            <div className="min-w-0">
              <h2
                ...
                className="font-display text-ink-on-inverse mb-2.5 text-[28px] leading-[1.16] font-normal tracking-[-0.02em] md:text-[30px]"
              >
                {FINAL_HEADING}
              </h2>
